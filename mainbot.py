...
helpMessage = "BELLA RAGA, SONO yuk0nBot! VI AIUTERÒ A NON PERDERE TRACCIA DEI TASK DISPONIBILI\n\nPer utilizzarmi, \
...
def on_chat_message(msg):
    ...
    if content_type == "text":
        ...
        if(msg["text"].startswith(config.getPower())):
                        ...
                        taxt = taxt.upper()
                        #bot.sendMessage("",taxt) # da cambiare l'id del gruppo
        if(msg["text"] == "/help" or msg["text"] == "/help@Yuk0nbot"):
        ...
        if(msg["text"] == "/valuta" or msg["text"] == "/valuta@Yuk0nbot"):
            bot.sendMessage(chat_id, "Attualmente, 1 dollaro = "+converted+" euro.")
        if(msg["text"] == "/glossario" or msg["text"] == "/glossario@Yuk0nbot"):
